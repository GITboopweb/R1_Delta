	...
	while(1)
	{
		...
		if(time_up)
		{
			...
			switch (run_mode)
			{
				...
				default:{can_bus.bsp.CAN1_CMD_1(pid_controller.can_motor.pid_call_1(0,1),pid_controller.can_motor.pid_call_1(0,2),pid_controller.can_motor.pid_call_1(0,3),0);}break;
